...
{
    public partial class FeedbackFormIND : Form
    {
        string hostName = "xyz";
        Boolean check = false;
       ...
       public List<string> subCatList = new List<string>();
        ...
        string catstr = "";
        string substr = "";
        public FeedbackFormIND(List<string> lst,DataTable dt)
        {
            dtCategory = dt;
             InitializeComponent();
            subCatList = lst;
        ...
        {// string jsonString argument
            FeedbackFormIND ff = new FeedbackFormIND();
            ...
            try
            {
                ...
                using (var wb = new WebClient())
                {
                    data = Environment.UserName; ;
                     ...
                     response = wb.DownloadString("https://quickitsupport.gdn.accenture.com/starttool/getcat.php");
            ...
            if (!checkData())
            {
                ...
                try
                {
                    using (var wb = new WebClient())
                    {
                        ...
                        var response = wb.UploadValues("https://quickitsupport.gdn.accenture.com/starttool/savefeedback_new.php", "POST", senddata);
        ...
        private void linkLabelloginc_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            ...
            try
            {
                ...
                using (var wb = new WebClient())
                {
                    ...
                    var sendData = new NameValueCollection();
                    sendData.Add("d1", encrypted);
                    var response = wb.UploadValues("https://quickitsupport.gdn.accenture.com/starttool/incident.php", "POST", sendData);
        ...
        private void FeedbackFormIND_FormClosing(object sender, FormClosingEventArgs e)
        {
