...
{
    public partial class HomeFormInd : Form
    {
        Thread thread = null;
        ...
        public HomeFormInd(DataTable catdt)
        {
            categoryData = catdt;
            InitializeComponent();
        }
            ...
            if (solution!=null)
            {
                ...
                {                   
                    ...
                    using (var wb = new WebClient())
                    {
                        ...
                        var response = wb.UploadValues("https://quickitsupport.gdn.accenture.com/starttool/savelog_new.php", "POST", senddata);
        ...
        private void freeDiskSpaceToolStripMenuItem_Click(object sender, EventArgs e)
        {
           ...
           // tabControl1.Visible = false;
            ...
            remoteUri = "https://quickitsupport.gdn.accenture.com//solution/DiskSpace_Cleanup.exe";
        ...
        private void unsecureDeviceToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            fileName = "C:\\temp\\Unsecured_device_fix.exe"; 
             remoteUri = "https://quickitsupport.gdn.accenture.com//solution/Unsecured_device_fix.exe";
            string myStringWebResource = null;
            myStringWebResource = remoteUri;
            // myWebClient.DownloadFile(myStringWebResource, @fileName);
            btnFix.Visible = true;
        ...
        private void removeUnauthoriseToolStripMenuItem_Click(object sender, EventArgs e)
        {
           ...
           // tabControl1.Visible = false;
            ...
            remoteUri = "https://quickitsupport.gdn.accenture.com//solution/Removal_of_Unauthorised_user_EID_from_Avecto_Group.exe";
            string myStringWebResource = null;
        ...
        private void deleteSavedPasswordToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            remoteUri = "https://quickitsupport.gdn.accenture.com//solution/Clear_Saved_Passwords.exe";
            string myStringWebResource = null;
...
"3)Choose “Zero Touch Solutions - Patch NC Remediation”."+Environment.NewLine+"4) Install the Solution and then Restart the Laptop.";
        ...
        private void encryptionFixToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            txtDetails.Text = "If you want to fix Encryption Noncompliance issue, please click on the button below."
               ...
               "1) Go to “Windows Search” and type “Software Center”." + Environment.NewLine +
"2) Click on “Applications” folder." + Environment.NewLine +
"3)Choose “Zero Touch Solutions - Encryption NC Remediation”." + Environment.NewLine + "4) Install the Solution and then Restart the Laptop.";
            ...
            remoteUri = "https://quickitsupport.gdn.accenture.com//solution/Encryption_NC_Remediation.exe";
            string myStringWebResource = null;
        ...
        private void chromeFixToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            remoteUri = "https://quickitsupport.gdn.accenture.com//solution/GoogleChrome_NC_Remediation.exe";
        ...
        private void taniumFixToolStripMenuItem_Click(object sender, EventArgs e)
        {
           ...
           // tabControl1.Visible = false;
            ...
            remoteUri = "https://quickitsupport.gdn.accenture.com//solution/TaniumCheck.exe";
            string myStringWebResource = null;
            // Create a new WebClient instance.
        ...
        private void office365FixToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            remoteUri = "https://quickitsupport.gdn.accenture.com//solution/Office365_NC_Remediation.exe";
            string myStringWebResource = null;
            // Create a new WebClient instance.
        ...
        private void outlookToolStripMenuItem_Click(object sender, EventArgs e)
        {
          ...
          //  tabControl1.Visible = false;
            ...
            remoteUri = "https://quickitsupport.gdn.accenture.com//solution/Outlook_Profile_Deletion_Creation.exe";
            string myStringWebResource = null;
        ...
        private void office365ReinstallationToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            remoteUri = "https://quickitsupport.gdn.accenture.com//solution/Office365_Reinstall.exe";
            string myStringWebResource = null;
            // Create a new WebClient instance.
...
"8.Click 'Submit'." + Environment.NewLine;
        ...
        private void mSTeamsMeetingAddinIssueToolStripMenuItem_Click(object sender, EventArgs e)
        {
           ...
           // tabControl1.Visible = false;
            ...
            remoteUri = "https://quickitsupport.gdn.accenture.com//solution/Teams_Meeting_Addin_issue.exe";
            string myStringWebResource = null;
            // Create a new WebClient instance.
...
"4. Click on Add and Enter the Details and then follow the instructions.";
        ...
        private void citrixFixToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            if (citrixFix == DialogResult.Yes)
            {
                ...
                using (var wb = new WebClient())
                {
                    ...
                    var response = wb.UploadValues("https://quickitsupport.gdn.accenture.com/starttool/citrix_log.php", "POST", senddata);
                ...
                txtDetails.Text = "If you wish to reinstall/ fix Citrix issue, please click on the button below." + Environment.NewLine + "Please save all your work, system will restart after execution of solution. Avecto Rights must be needed to execute the below solution."
                     + Environment.NewLine + Environment.NewLine + "For AIOC users, follow the below Instructions:" + Environment.NewLine +
                     "1) Go to Windows Search and type “Software center”." + Environment.NewLine + "2) Click on “Applications” folder." + Environment.NewLine + "3) Choose “Zero Touch Solutions - Citrix Receiver." + Environment.NewLine + "4) Install the Solution and then Restart the Laptop.";
                scriptname = "Citrix Receiver Fix";

                fileName = "C:\\temp\\Citrix_WorkSpace_Reinstallation.exe";
                remoteUri = "https://quickitsupport.gdn.accenture.com//solution/Citrix_Receiver.exe";
                string myStringWebResource = null;
                // Create a new WebClient instance.
        ...
        private void javaNCRemediationToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            txtDetails.Text = "Do you want to fix Java compliance issue? click a button below to run solution. Avecto Rights must be needed to execute the below solution." 
                ...
                "1) Go to “Windows Search” and type “Software Center”." + Environment.NewLine +
"2) Click on “Applications” folder." + Environment.NewLine +
"3)Choose “Zero Touch Solutions - Java NC Remediation”." + Environment.NewLine + "4) Install the Solution and then Restart the Laptop."; ;
            scriptname = "Java NC  Remediation";

            fileName = "C:\\temp\\Java_Compliance_Checkv1.exe";
            remoteUri = "https://quickitsupport.gdn.accenture.com//solution/Java_Compliance_Checkv1.exe";
            string myStringWebResource = null;
            // Create a new WebClient instance.
        ...
        private void phishMeCheckToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            remoteUri = "https://quickitsupport.gdn.accenture.com//solution/PhishMe_Check.exe";
            string myStringWebResource = null;
            btnFix.Visible = true;
            txtDetails.ForeColor= System.Drawing.Color.Black;
            btnHfbPin.Visible = false;
        ...
        private void antiVirusFixToolStripMenuItem_Click_1(object sender, EventArgs e)
        {
            ...
            txtDetails.Text =
                            ...
                            "1) Go to “Windows Search” and type “Software Center”." + Environment.NewLine +
"2) Click on “Applications” folder." + Environment.NewLine +
"3)Choose “Touchless IT - MDfE_NC_Remediation”." + Environment.NewLine + "4) Install the Solution and then Restart the Laptop."; ;
            ...
            remoteUri = "https://quickitsupport.gdn.accenture.com//solution/MDfE_AVFW_NC_Remediation.exe";
        ...
        private void citrixWorkspaceFixToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            if (citrixFix == DialogResult.Yes)
            {
                ...
                Environment.NewLine + Environment.NewLine + "For AIOC users, Follow the below Instructions:" + Environment.NewLine + Environment.NewLine +
                                 "1) Go to Windows Search and type “Software center”." + Environment.NewLine + "2) Click on “Application” folder." + Environment.NewLine + "3) Choose “Zero Touch Solutions - Citrix Workspace."
                                 + Environment.NewLine + "4) Install the Solution and then Restart the Laptop.";
                scriptname = "Citrix Workspace Fix";

                fileName = "C:\\temp\\Citrix_WorkSpace.exe";
                remoteUri = "https://quickitsupport.gdn.accenture.com//solution/Citrix_WorkSpace.exe";
                string myStringWebResource = null;
                // Create a new WebClient instance.
        ...
        private void firewallCheckToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            remoteUri = "https://quickitsupport.gdn.accenture.com//solution/Firewall_Check.exe";
            string myStringWebResource = null;
            // Create a new WebClient instance.
        ...
        private void toolStripSoftwareCenterUpdateFix_Click(object sender, EventArgs e)
        {
            ...
            remoteUri = "https://quickitsupport.gdn.accenture.com//solution/Software_Center_Update_Fix.exe";
            string myStringWebResource = null;
            // Create a new WebClient instance.
        ...
        private void toolStripMenuSCCMNotWorkingFix_Click(object sender, EventArgs e)
        {
            ...
            remoteUri = "https://quickitsupport.gdn.accenture.com//solution/SCCM_Not_Working_Fix.exe";
            string myStringWebResource = null;
            // Create a new WebClient instance.
        ...
        private void WindowsActiveFixtoolStripMenu_Click(object sender, EventArgs e)
        {
            ...
            remoteUri = "https://quickitsupport.gdn.accenture.com//solution/Windows_Activation_fix.exe";
            string myStringWebResource = null;
            // Create a new WebClient instance.
        ...
        private void DefenderNotOpeningFixtoolStripMenu_Click(object sender, EventArgs e)
        {
            ...
            remoteUri = "https://quickitsupport.gdn.accenture.com//solution/Defender_NotOpening.exe";
            string myStringWebResource = null;
            // Create a new WebClient instance.
        ...
        private void SmartCardLogonFixtoolStripMenu_Click(object sender, EventArgs e)
        {
            ...
            remoteUri = "https://quickitsupport.gdn.accenture.com//solution/Smart_CardLogon_Fix.exe";
            string myStringWebResource = null;
            // Create a new WebClient instance.
        ...
        private void toolStripMenuWindowsFileExploreFix_Click(object sender, EventArgs e)
        {
            ...
            remoteUri = "https://quickitsupport.gdn.accenture.com//solution/Windows_File_Explorer_Ribbon_Fix.exe";
            string myStringWebResource = null;
            // Create a new WebClient instance.
        ...
        private void toolStripRestoreandRepairSystemFix_Click(object sender, EventArgs e)
        {
            ...
            remoteUri = "https://quickitsupport.gdn.accenture.com//solution/Restore_and_Repair_Corrupted_System_File_Fix.exe";
            string myStringWebResource = null;
            // Create a new WebClient instance.
        ...
        private void TaskbarFixtoolStripMenu_Click(object sender, EventArgs e)
        {
            ...
            remoteUri = "https://quickitsupport.gdn.accenture.com//solution/Taskbar_Fix.exe";
            string myStringWebResource = null;
            // Create a new WebClient instance.
        ...
        private void ClearGroupPolicyCachetoolStripMenu_Click(object sender, EventArgs e)
        {
            ...
            remoteUri = "https://quickitsupport.gdn.accenture.com//solution/Clear_Group_PolicyCache.exe";
            string myStringWebResource = null;
            // Create a new WebClient instance.
        ...
        private void IPUInstallFixtoolStripMenu_Click(object sender, EventArgs e)
        {
            ...
            remoteUri = "https://quickitsupport.gdn.accenture.com//solution/IPU_Unable_to_install_Fix.exe";
            string myStringWebResource = null;
            // Create a new WebClient instance.
        ...
        private void NetFrameworkFixtoolStripMenu_Click(object sender, EventArgs e)
        {
            ...
            remoteUri = "https://quickitsupport.gdn.accenture.com//solution/Net_Framework_Fix.exe";
            string myStringWebResource = null;
            // Create a new WebClient instance.
        ...
        private void toolStripMenuWorkstationSystemIssue_Click(object sender, EventArgs e)
        {
            ...
            remoteUri = "https://quickitsupport.gdn.accenture.com//solution/Windows_Workstation_Network_Access_Issue.exe";
            string myStringWebResource = null;
            // Create a new WebClient instance.
        ...
        private void button12_Click(object sender, EventArgs e)
        {
            if (scriptname == "HfB PIN Reset Options")
            {
                ...
                Process.Start("https://quickitsupport.gdn.accenture.com/start_doc/Using_the_system_setting_if_your_desktop_is_in_unlocked_screen_mode.pdf");
            }
            if (scriptname == "FIDO2 Set-up and Registration")
            {
                ...
                Process.Start("https://quickitsupport.gdn.accenture.com/start_doc/FIDO2_Token_Setup_and_Registration_for_Windows_(OS).pdf");
            }
            if (scriptname == "Ordering a FIDO2 Token")
            {
                ...
                Process.Start("https://quickitsupport.gdn.accenture.com/start_doc/Recommended_Tokens.pdf");
            }
        ...
        private void btnHfbT2_Click(object sender, EventArgs e)
        {
            if (scriptname == "HfB PIN Reset Options")
            {
                ...
                subcategory.Add("HfB PIN Reset Options");
                saveExecutionLog("HfB PIN Reset Options");
                Process.Start("https://quickitsupport.gdn.accenture.com/start_doc/Passwordless_Enabled_Using_the_system_settings_from_the_unlocked_screen.pdf");
            }
            if (scriptname == "FIDO2 Set-up and Registration")
            {
                executed = true;
                subcategory.Add("FIDO2 Set-up and Registration");
                saveExecutionLog("FIDO2 Set-up and Registration");
                Process.Start("https://quickitsupport.gdn.accenture.com/start_doc/FIDO2_Token_Setup_and_Registration_for_MAC_(OS).pdf");
            }
            if (scriptname == "Ordering a FIDO2 Token")
            {
                executed = true;
                subcategory.Add("Ordering a FIDO2 Token");
                saveExecutionLog("Ordering a FIDO2 Token");
                Process.Start("https://quickitsupport.gdn.accenture.com/start_doc/Users_unable_to_locate_their_shipping_address_during_profile_setup.pdf");
            }
        }
        ...
        private void btnHfbT3_Click(object sender, EventArgs e)
        {
            if (scriptname == "HfB PIN Reset Options")
            {
                ...
                subcategory.Add("HfB PIN Reset Options");
                saveExecutionLog("HfB PIN Reset Options");
                Process.Start("https://quickitsupport.gdn.accenture.com/start_doc/Passwordless_Enabled_Pin_Reset_from_the_locked_screen.pdf");
            }
            if (scriptname == "FIDO2 Set-up and Registration")
            {
                executed = true;
                subcategory.Add("FIDO2 Set-up and Registration");
                saveExecutionLog("FIDO2 Set-up and Registration");
                Process.Start("https://quickitsupport.gdn.accenture.com/start_doc/Registering_a_FIDO2_Token_Key_for_Privileged_Accounts.pdf");
            }
            if (scriptname == "Ordering a FIDO2 Token")
            {
                executed = true;
                subcategory.Add("Ordering a FIDO2 Token");
                saveExecutionLog("Ordering a FIDO2 Token");
                Process.Start("https://quickitsupport.gdn.accenture.com/start_doc/Search_results_indicate_that_the_Feitian_products_are_not_found.pdf");
            }
        ...
        private void HFBManualEnrollToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            Process.Start("https://quickitsupport.gdn.accenture.com/start_doc/ACN_Hfb_Manual_Enrollment_utility_Instructions.pdf");
            executed = true;
        }
        ...
        private void toolStripMenuHFBAutoEnroll_Click(object sender, EventArgs e)
        {
            ...
            Process.Start("https://quickitsupport.gdn.accenture.com/start_doc/ACN_Hfb_Automated_Enrollment_utility_Instructions.pdf");
            executed = true;
        }
        ...
        private void HomeForm_FormClosing_1(object sender, FormClosingEventArgs e)
        {
            if (executed == true)
            {
                ...
                FeedbackFormIND feedback = new FeedbackFormIND(subcategory, categoryData);
                feedback.ShowDialog();
        ...
        private void toolStripMenuReachTool_Click(object sender, EventArgs e)
        {
            ...
            txtDetails.Visible = true;
            panel1.Visible = false;
            txtDetails.Text = "“Remote Access Chanel”(REACH). It’s one of our Accenture Inhouse Tool, which is useful for troubleshooting Tech Related issues remotely by generating 9 Digit Secret key, tool comply with our legal and security standards, hence employees are recommended to access REACH application to authenticate with ISA technicians remotely to fix Tech related issues.";
            scriptname = "REACH Tool";
            //fileName = "C:\\Users\\REACH_TOOL_V1.1_Windows.exe"; string downloadsPath = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.UserProfile), "Downloads");
            string downloadsPath = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.UserProfile), "Downloads");
            string file = "REACH_TOOL_V1.1_Windows.exe";
            string filePath = Path.Combine(downloadsPath, file);
            fileName = filePath;
            remoteUri = "https://quickitsupport.gdn.accenture.com/solution/REACH_TOOL_V1.1_Windows.exe";
        ...
        private void MyWebClient_Downloadreach(object sender, AsyncCompletedEventArgs e)
        {
            ...
            isdownloaded = true;
            allow = "true";
            var reach = MessageBox.Show("REACH Tool Downloaded Successfully", "message", MessageBoxButtons.OK, MessageBoxIcon.Information);
            if (reach == DialogResult.OK)
            {
                //executed = true;
                subcategory.Add("REACH Tool");
                saveExecutionLog("REACH Tool");
                //Process.Start("C:\\Users\\REACH_TOOL_V1.1_Windows.exe");
                string downloadsPath = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.UserProfile), "Downloads");
                string file = "REACH_TOOL_V1.1_Windows.exe";
                string filePath = Path.Combine(downloadsPath, file);
                fileName = filePath;
                showMessage("It takes 10-15 Seconds to Open REACH TOOL, Please Select OK and wait..", "OK");
                Process.Start(fileName);
                enableControl();              
            }

        }
        private void MyWebClient_DownloadreachAdmin(object sender, AsyncCompletedEventArgs e)
        {
            if (thread != null && thread.IsAlive)
            {
                thread.Abort();
            ...
            isdownloaded = true;
            allow = "true";
            var reach = MessageBox.Show("REACH Tool Downloaded with AdminRights Successfully", "message", MessageBoxButtons.OK, MessageBoxIcon.Information);
            if (reach == DialogResult.OK)
            {
                //executed = true;
                subcategory.Add("REACH Tool");
            ...
            if (fileName != null)
            {
                ...
                if (ifFileExist)
                {
                    ...
                    try
                    {
                        ...
                        myWebClient.CachePolicy = policy;
                        myWebClient.DownloadProgressChanged += MyWebClient_DownloadProgressChanged;
                        myWebClient.DownloadFileCompleted += MyWebClient_DownloadreachAdmin;
        ...
        private void PharosSentryPrintGuideMenuItem85_Click(object sender, EventArgs e)
        {
            subcategory.Add(sender.ToString());
            saveExecutionLog(sender.ToString());
            Process.Start("https://in.accenture.com/mycomputer/printing-faxing-scanning/");
            executed = true;
        }

        private void ReachAdmin()
        {
