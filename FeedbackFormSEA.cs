...
{
    public partial class FeedbackFormSEA : Form
    {
        string hostName = "xyz";
        Boolean check = false;
       ...
       public List<string> subCatList = new List<string>();
        ...
        string catstr = "";
        string substr = "";
        public FeedbackFormSEA(List<string> lst,DataTable dt)
        {
            dtCategory = dt;
             InitializeComponent();
            subCatList = lst;
        ...
        {// string jsonString argument
            FeedbackFormSEA ff = new FeedbackFormSEA();
            ...
            try
            {
                ...
                using (var wb = new WebClient())
                {
                    data = Environment.UserName ;
                     ...
                     response = wb.DownloadString("https://quickitsupport.gdn.accenture.com/starttool_sea/getcat.php");
            ...
            if (!checkData())
            {
                ...
                try
                {
                    using (var wb = new WebClient())
                    {
                        ...
                        var response = wb.UploadValues("https://quickitsupport.gdn.accenture.com/starttool_sea/savefeedback.php", "POST", senddata);
                        //var response = wb.UploadValues("http://localhost:8080/Feedback/feedbacksea.php", "POST", senddata);
                        string responseInString = Encoding.UTF8.GetString(response);
                    }
        ...
        private void linkLabelloginc_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            ...
            try
            {
                ...
                using (var wb = new WebClient())
                {
                    ...
                    var sendData = new NameValueCollection();
                    sendData.Add("d1", encrypted);
                    var response = wb.UploadValues("https://quickitsupport.gdn.accenture.com/starttool_sea/incident.php", "POST", sendData);

                    //var response = wb.UploadValues("http://localhost:8080/Feedback/incidentsea.php", "POST", sendData);
        ...
        private void FeedbackFormSEA_FormClosing(object sender, FormClosingEventArgs e)
        {
