...
{
    public partial class FeedbackFormJapan : Form
    {
        string hostName = "xyz";
        Boolean check = false;
       ...
       public List<string> subCatList = new List<string>();
        ...
        string catstr = "";
        string substr = "";
        public FeedbackFormJapan(List<string> lst,DataTable dt)
        {
            dtCategory = dt;
             InitializeComponent();
            subCatList = lst;
        ...
        {// string jsonString argument
            FeedbackFormJapan ff = new FeedbackFormJapan();
            ...
            try
            {
                ...
                using (var wb = new WebClient())
                {
                    data = Environment.UserName; 
                     ...
                     response = wb.DownloadString("https://quickitsupport.gdn.accenture.com/starttool_japan/getcat.php");
                ...
                try
                {
                    using (var wb = new WebClient())
                    {
                       ...
                       /* if (cbCategory.SelectedItem.ToString() == "Solution Not Available")
                        ...
                        var response = wb.UploadValues("https://quickitsupport.gdn.accenture.com/starttool_japan/savefeedback.php", "POST", senddata);
        ...
        private void linkLabelloginc_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            ...
            try
            {
                ...
                using (var wb = new WebClient())
                {
                    ...
                    var sendData = new NameValueCollection();
                    sendData.Add("d1", encrypted);
                    var response = wb.UploadValues("https://quickitsupport.gdn.accenture.com/starttool_japan/incident.php", "POST", sendData);
