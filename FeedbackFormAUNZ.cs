...
{
    public partial class FeedbackFormAUNZ : Form
    {
        string hostName = "xyz";
        Boolean check = false;
       ...
       public List<string> subCatList = new List<string>();
        ...
        string catstr = "";
        string substr = "";
        public FeedbackFormAUNZ(List<string> lst,DataTable dt)
        {
            dtCategory = dt;
             InitializeComponent();
            subCatList = lst;
        ...
        {// string jsonString argument
            FeedbackFormAUNZ ff = new FeedbackFormAUNZ();
            ...
            try
            {
                ...
                using (var wb = new WebClient())
                {
                    data = Environment.UserName; 
                     ...
                     response = wb.DownloadString("https://quickitsupport.gdn.accenture.com/starttool_anz/getcat.php");
                ...
                try
                {
                    using (var wb = new WebClient())
                    {
                        ...
                        /* var data = new Dictionary<string, string>();
                         ...
                         data.Add("username", hostName);
                         data.Add("category", cbCategory.SelectedItem.ToString());
                         data.Add("sbcategory", cbSubCategory.SelectedItem.ToString());
                         data.Add("rating", rating);
                         data.Add("comments", txtComments.Text);
                         data.Add("resolve", resolve);*/
                        string data="";
                       /* if (cbCategory.SelectedItem.ToString() == "Solution Not Available")
                        {

                            data = "username:" + hostName + ",category :" + cbCategory.SelectedItem.ToString() + ", sbcategory : Not Found" +  
                                ", rating : No"  + ", comments :" + txtComments.Text + ",resolve:" + resolve + ",location:" + cbLocation.SelectedItem.ToString();
                        }
                        else if(cbCategory.SelectedItem.ToString()== "Multiple Solutions/ Issues")
                        {
                            data = "username:" + hostName + ",category :" + cbCategory.SelectedItem.ToString() + ", sbcategory : multiple solution" +
                                ", rating :"+rating + ", comments :" + txtComments.Text + ",resolve:" + resolve + ",location:" + cbLocation.SelectedItem.ToString();
                        }
                        else
                        {*/
                            string txt = "";
                        ...
                        var response = wb.UploadValues("https://quickitsupport.gdn.accenture.com/starttool_anz/savefeedback.php", "POST", senddata);
        ...
        private void linkLabelloginc_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            ...
            try
            {
                ...
                using (var wb = new WebClient())
                {
                    ...
                    var sendData = new NameValueCollection();
                    sendData.Add("d1", encrypted);
                    var response = wb.UploadValues("https://quickitsupport.gdn.accenture.com/starttool_anz/incident.php", "POST", sendData);
        ...
        private void FeedbackFormAUNZ_FormClosing(object sender, FormClosingEventArgs e)
        {
