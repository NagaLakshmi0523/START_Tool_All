...
{
    public partial class FeedbackFormUKI : Form
    {
        string hostName = "xyz";
        Boolean check = false;
       ...
       public List<string> subCatList = new List<string>();
        ...
        string catstr = "";
        string substr = "";
        public FeedbackFormUKI(List<string> lst,DataTable dt)
        {
            dtCategory = dt;
             InitializeComponent();
            subCatList = lst;
        ...
        {// string jsonString argument
            FeedbackFormUKI ff = new FeedbackFormUKI();
            ...
            try
            {
                ...
                using (var wb = new WebClient())
                {
                    data = Environment.UserName; ;
                     ...
                     response = wb.DownloadString("https://quickitsupport.gdn.accenture.com/starttool_uk/getcat.php");
            ...
            if (!checkData())
            {
                ...
                try
                {
                    using (var wb = new WebClient())
                    {
                        ...
                        var response = wb.UploadValues("https://quickitsupport.gdn.accenture.com/starttool_uk/savefeedback.php", "POST", senddata);
        ...
        private void linkLabelloginc_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            ...
            try
            {
                ...
                using (var wb = new WebClient())
                {
                    ...
                    var sendData = new NameValueCollection();
                    sendData.Add("d1", encrypted);
                    var response = wb.UploadValues("https://quickitsupport.gdn.accenture.com/starttool_uk/incident.php", "POST", sendData);
        ...
        private void FeedbackFormUKI_Load(object sender, EventArgs e)
        {
        ...
        private void FeedbackFormUKI_FormClosing(object sender, FormClosingEventArgs e)
        {
