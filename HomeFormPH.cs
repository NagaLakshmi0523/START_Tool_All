...
{
    public partial class HomeFormPH : Form
    {
        Thread thread = null;
        ...
        public HomeFormPH(DataTable catdt )
        {
            categoryData = catdt;   
            InitializeComponent();
            ...
            if (solution!=null)
            {
                try
                {
                    ...
                    using (var wb = new WebClient())
                    {
                        ...
                        var response = wb.UploadValues("https://quickitsupport.gdn.accenture.com/starttool_ph/savelog.php", "POST", senddata);
        ...
        private void freeDiskSpaceToolStripMenuItem_Click(object sender, EventArgs e)
        {
           ...
           // tabControl1.Visible = false;
            ...
            txtDetails.Text = "If you are facing problem regarding full disk space. You can remediate this issue just by clearing space from temp, prefetch, recycle bin, windows cache. If you wish to free up disk space, click on button below. Avecto Rights must be needed to execute the below solution.";
            scriptname = "Free Disk Space";

            fileName = "C:\\temp\\DiskSpace_Cleanup.exe";
            remoteUri = "https://quickitsupport.gdn.accenture.com//solution/ph_solutions/DiskSpace_Cleanup.exe";
        ...
        private void unsecureDeviceToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            fileName = "C:\\temp\\Unsecured_device_fix.exe"; 
             remoteUri = "https://quickitsupport.gdn.accenture.com//solution/ph_solutions/Unsecured_device_fix.exe";
            string myStringWebResource = null;
            myStringWebResource = remoteUri;
            // myWebClient.DownloadFile(myStringWebResource, @fileName);
            btnFix.Visible = true;
        ...
        private void removeUnauthoriseToolStripMenuItem_Click(object sender, EventArgs e)
        {
           ...
           // tabControl1.Visible = false;
            ...
            remoteUri = "https://quickitsupport.gdn.accenture.com//solution/ph_solutions/Removal_of_Unauthorised_user_EID_from_Avecto_Group.exe";
            string myStringWebResource = null;
        ...
        private void deleteSavedPasswordToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            remoteUri = "https://quickitsupport.gdn.accenture.com//solution/ph_solutions/Clear_Saved_Passwords.exe";
            string myStringWebResource = null;
...
Environment.NewLine+ "Replication on portal takes 48 to 72 business hours post execution of the solution.";
           // txtDetails.AppendText()
            ...
            remoteUri = "https://quickitsupport.gdn.accenture.com//solution/ph_solutions/Patch_NC_Remediation.exe";
            string myStringWebResource = null;
       ...
       // https://mytechhelp.accenture.com/downloadExe/EncryptionRemediation/EnterpriseId
            ...
            remoteUri = "https://quickitsupport.gdn.accenture.com//solution/ph_solutions/Encryption_NC_Remediation.exe";
            string myStringWebResource = null;
        ...
        private void chromeFixToolStripMenuItem_Click(object sender, EventArgs e)
        {
           ...
           // tabControl1.Visible = false;
            ...
            remoteUri = "https://quickitsupport.gdn.accenture.com//solution/ph_solutions/GoogleChrome_NC_Remediation.exe";
        ...
        private void secureWebFixToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            remoteUri = "https://quickitsupport.gdn.accenture.com//solution/ph_solutions/ForcePoint_Compliance_Check.exe";
            string myStringWebResource = null;
        ...
        private void taniumFixToolStripMenuItem_Click(object sender, EventArgs e)
        {
           ...
           // tabControl1.Visible = false;
            ...
            remoteUri = "https://quickitsupport.gdn.accenture.com//solution/ph_solutions/TaniumCheck.exe";
            string myStringWebResource = null;
            // Create a new WebClient instance.
        ...
        private void eEVAFixToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            remoteUri = "https://quickitsupport.gdn.accenture.com//solution/ph_solutions/EVTA_NC_Remediation.exe";
            string myStringWebResource = null;
            // Create a new WebClient instance.
        ...
        private void office365FixToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            remoteUri = "https://quickitsupport.gdn.accenture.com//solution/ph_solutions/Office365_NC_Remediation.exe";
            string myStringWebResource = null;
            // Create a new WebClient instance.
        ...
        private void outlookToolStripMenuItem_Click(object sender, EventArgs e)
        {
          ...
          //  tabControl1.Visible = false;
            ...
            remoteUri = "https://quickitsupport.gdn.accenture.com//solution/ph_solutions/Outlook_Profile_Deletion_Creation.exe";
            string myStringWebResource = null;
        ...
        private void office365ReinstallationToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            remoteUri = "https://quickitsupport.gdn.accenture.com//solution/ph_solutions/Office365_Reinstall.exe";
            string myStringWebResource = null;
            // Create a new WebClient instance.
        ...
        private void adminRightsToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            //remoteUri = "https://quickitsupport.gdn.accenture.com//solution/ph_solutions/Avecto_Admin_Access_Automation_V1.01.exe";
        ...
        private void vCBookingToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            subcategory.Add(sender.ToString());
            saveExecutionLog(sender.ToString());
            Process.Start("https://quickitsupport.gdn.accenture.com/ph_doc/MS_Teams_Booking_Procedure_1.2.pdf");
            executed = true;
        }
...
"8.Click 'Submit'." + Environment.NewLine;
        ...
        private void txtDetails_LinkClicked(object sender, LinkClickedEventArgs e)
        {
            ...
            if(scriptname== "Accenture VPN Fix")
            {
                ...
                Process.Start("https://quickitsupport.gdn.accenture.com/ph_doc/VPN-Access.pdf");
            }
        ...
        private void mSTeamsMeetingAddinIssueToolStripMenuItem_Click(object sender, EventArgs e)
        {
           ...
           // tabControl1.Visible = false;
            ...
            remoteUri = "https://quickitsupport.gdn.accenture.com//solution/ph_solutions/Teams_Meeting_Addin_issue.exe";
            string myStringWebResource = null;
            // Create a new WebClient instance.
...
"4. Click on Add and Enter the Details and then follow the instructions.";
        ...
        private void citrixFixToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            if (citrixFix == DialogResult.Yes)
            {
                ...
                using (var wb = new WebClient())
                {
                    ...
                    var response = wb.UploadValues("https://quickitsupport.gdn.accenture.com/starttool_ph/citrix_log.php", "POST", senddata);
                ...
                remoteUri = "https://quickitsupport.gdn.accenture.com//solution/ph_solutions/Citrix_Receiver.exe";
                string myStringWebResource = null;
                // Create a new WebClient instance.
        ...
        private void vPNFixToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            txtDetails.Text = "Please access the below link to check the Status of Accenture VPN access" +
                Environment.NewLine + "https://quickitsupport.gdn.accenture.com/ph_doc/VPN-Access.pdf"
            ...
            remoteUri = "https://quickitsupport.gdn.accenture.com//solution/ph_solutions/Basic_VPN_Fix.exe";
            string myStringWebResource = null;
            // Create a new WebClient instance.
        ...
        private void softwareUnavailableToolStripMenuItem_Click(object sender, EventArgs e)
        {
            subcategory.Add(sender.ToString());
            saveExecutionLog(sender.ToString());
            Process.Start("https://quickitsupport.gdn.accenture.com/ph_doc/software_not_found.pdf");
            executed = true;
        }
        ...
        private void vCCostToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            Process.Start("https://quickitsupport.gdn.accenture.com/ph_doc/VC_Booking_Cost_and_Other_Details.pdf");
            executed = true;
        ...
        private void overallNCRemediationToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            remoteUri = "https://quickitsupport.gdn.accenture.com//solution/ph_solutions/Overall_NC_Remediation.exe";
            string myStringWebResource = null;
            // Create a new WebClient instance.
        ...
        private void javaNCRemediationToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            remoteUri = "https://quickitsupport.gdn.accenture.com//solution/ph_solutions/Java_Compliance_Checkv1.exe";
            string myStringWebResource = null;
            // Create a new WebClient instance.
        ...
        private void phishMeCheckToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            remoteUri = "https://quickitsupport.gdn.accenture.com//solution/ph_solutions/PhishMe_Check.exe";
            string myStringWebResource = null;
            btnFix.Visible = true;
            txtDetails.ForeColor= System.Drawing.Color.Red;
        }
        ...
        private void antiVirusFixToolStripMenuItem_Click_1(object sender, EventArgs e)
        {
            ...
            remoteUri = "https://quickitsupport.gdn.accenture.com//solution/ph_solutions/MDfE_AVFW_NC_Remediation.exe";
        ...
        private void beyondTrustPMFixToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            remoteUri = "https://quickitsupport.gdn.accenture.com//solution/ph_solutions/BeyondTrust_PM_compliance.exe";
            string myStringWebResource = null;
            btnFix.Visible = true;
            txtDetails.ForeColor= System.Drawing.Color.Black;
        }
        ...
        private void pulseSecureReinstallationexeToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            remoteUri = "https://quickitsupport.gdn.accenture.com//solution/ph_solutions/PulseSecure_Reinstallation.exe";
            string myStringWebResource = null;
            // Create a new WebClient instance.
        ...
        private void citrixWorkspaceFixToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            if (citrixFix == DialogResult.Yes)
            {
                ...
                remoteUri = "https://quickitsupport.gdn.accenture.com//solution/ph_solutions/Citrix_WorkSpace.exe";
                string myStringWebResource = null;
                // Create a new WebClient instance.
        ...
        private void firewallCheckToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            remoteUri = "https://quickitsupport.gdn.accenture.com//solution/ph_solutions/Firewall_Check.exe";
            string myStringWebResource = null;
            // Create a new WebClient instance.
        ...
        private void dLPCheckToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            remoteUri = "https://quickitsupport.gdn.accenture.com//solution/ph_solutions/DLP_Check.exe";
            string myStringWebResource = null;
            // Create a new WebClient instance.
        ...
        private void adobeReaderCheckToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            remoteUri = "https://quickitsupport.gdn.accenture.com//solution/ph_solutions/Adobe_Reader_Check.exe";
            string myStringWebResource = null;
            // Create a new WebClient instance.
        ...
        private void eVTACheckToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            remoteUri = "https://quickitsupport.gdn.accenture.com//solution/ph_solutions/EVTA_Check.exe";
            string myStringWebResource = null;
            // Create a new WebClient instance.
        ...
        private void adobeCreativeCloudSuiteCheckToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            remoteUri = "https://quickitsupport.gdn.accenture.com//solution/ph_solutions/adobeCreativeCloudSuite_Check.exe";
            string myStringWebResource = null;
            // Create a new WebClient instance.
        ...
        private void domainMembershipCheckToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            remoteUri = "https://quickitsupport.gdn.accenture.com//solution/ph_solutions/domainMembership_Check.exe";
            string myStringWebResource = null;
            // Create a new WebClient instance.
        ...
        private void unauthorizedSoftwareCheckToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            remoteUri = "https://quickitsupport.gdn.accenture.com//solution/ph_solutions/pythonSoftware_Check.exe";
            string myStringWebResource = null;
            // Create a new WebClient instance.
        ...
        private void chromeCheckToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            remoteUri = "https://quickitsupport.gdn.accenture.com//solution/ph_solutions/Chrome_Check.exe";
            string myStringWebResource = null;
            // Create a new WebClient instance.
        ...
        private void firefoxCheckToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            remoteUri = "https://quickitsupport.gdn.accenture.com//solution/ph_solutions/firefox_Check.exe";
            string myStringWebResource = null;
            // Create a new WebClient instance.
        ...
        private void edgeCheckToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            remoteUri = "https://quickitsupport.gdn.accenture.com//solution/ph_solutions/edge_Check.exe";
            string myStringWebResource = null;
            // Create a new WebClient instance.
        ...
        private void internetExplorerCheckToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            remoteUri = "https://quickitsupport.gdn.accenture.com//solution/ph_solutions/internetExplorer_Check.exe";
            string myStringWebResource = null;
            // Create a new WebClient instance.
        ...
        private void operaCheckToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            remoteUri = "https://quickitsupport.gdn.accenture.com//solution/ph_solutions/Opera_Check.exe";
            string myStringWebResource = null;
            // Create a new WebClient instance.
        ...
        private void unauthorizedSoftwareCheckToolStripMenuItem1_Click(object sender, EventArgs e)
        {
            ...
            remoteUri = "https://quickitsupport.gdn.accenture.com//solution/ph_solutions/unauthorizedSoftware_Check.exe";
            string myStringWebResource = null;
            // Create a new WebClient instance.
        ...
        private void operatingSystemCheckToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            remoteUri = "https://quickitsupport.gdn.accenture.com//solution/ph_solutions/os_Check.exe";
            string myStringWebResource = null;
            // Create a new WebClient instance.
        ...
        private void newJoinerLaptopSupportDeskToolStripMenuItem_Click(object sender, EventArgs e)
        {
           ...
           Process.Start("https://quickitsupport.gdn.accenture.com//ph_doc/newJoinerSupportDesk.pdf");
            executed = true;
            saveExecutionLog(sender.ToString());
            subcategory.Add(sender.ToString());
        ...
        private void dedicatedSupportToolStripMenuItem_Click(object sender, EventArgs e)
        {
            subcategory.Add(sender.ToString());
            saveExecutionLog(sender.ToString());
            Process.Start("https://quickitsupport.gdn.accenture.com//ph_doc/dedicatedSupport.pdf");
            executed = true;
        }
        ...
        private void toolStripSoftwareCenterUpdateFix_Click(object sender, EventArgs e)
        {
            ...
            remoteUri = "https://quickitsupport.gdn.accenture.com//solution/ph_solutions/Software_Center_Update_Fix.exe";
            string myStringWebResource = null;
            // Create a new WebClient instance.
        ...
        private void toolStripMenuSCCMNotWorkingFix_Click(object sender, EventArgs e)
        {
            ...
            remoteUri = "https://quickitsupport.gdn.accenture.com//solution/ph_solutions/SCCM_Not_Working_Fix.exe";
            string myStringWebResource = null;
            // Create a new WebClient instance.
        ...
        private void toolStripMenuWindowsFileExploreFix_Click(object sender, EventArgs e)
        {
            ...
            remoteUri = "https://quickitsupport.gdn.accenture.com//solution/ph_solutions/Windows_File_Explorer_Ribbon_Fix.exe";
            string myStringWebResource = null;
            // Create a new WebClient instance.
        ...
        private void toolStripRestoreandRepairSystemFix_Click(object sender, EventArgs e)
        {
            ...
            remoteUri = "https://quickitsupport.gdn.accenture.com//solution/ph_solutions/Restore_and_Repair_Corrupted_System_File_Fix.exe";
            string myStringWebResource = null;
            // Create a new WebClient instance.
        ...
        private void WindowsActiveFixtoolStripMenu_Click(object sender, EventArgs e)
        {
            ...
            remoteUri = "https://quickitsupport.gdn.accenture.com//solution/ph_solutions/Windows_Activation_fix.exe";
            string myStringWebResource = null;
            // Create a new WebClient instance.
        ...
        private void HFBPinFixtoolStripMenu_Click(object sender, EventArgs e)
        {
            ...
            remoteUri = "https://quickitsupport.gdn.accenture.com//solution/ph_solutions/HFB_Pin_Fix.exe";
            string myStringWebResource = null;
            // Create a new WebClient instance.
        ...
        private void DefenderNotOpeningFixtoolStripMenu_Click(object sender, EventArgs e)
        {
            ...
            remoteUri = "https://quickitsupport.gdn.accenture.com//solution/ph_solutions/Defender_NotOpening.exe";
            string myStringWebResource = null;
            // Create a new WebClient instance.
        ...
        private void SmartCardLogonFixtoolStripMenu_Click(object sender, EventArgs e)
        {
            ...
            remoteUri = "https://quickitsupport.gdn.accenture.com//solution/ph_solutions/Smart_CardLogon_Fix.exe";
            string myStringWebResource = null;
            // Create a new WebClient instance.
        ...
        private void TaskbarFixtoolStripMenu_Click(object sender, EventArgs e)
        {
            ...
            remoteUri = "https://quickitsupport.gdn.accenture.com//solution/ph_solutions/Taskbar_Fix.exe";
            string myStringWebResource = null;
            // Create a new WebClient instance.
        ...
        private void Windows11ClassicRightClickFixtoolStripMenu_Click(object sender, EventArgs e)
        {
            ...
            remoteUri = "https://quickitsupport.gdn.accenture.com//solution/ph_solutions/Windows11_Classic_right_click_feature.exe";
            string myStringWebResource = null;
            // Create a new WebClient instance.
        ...
        private void ClearGroupPolicyCachetoolStripMenu_Click(object sender, EventArgs e)
        {
            ...
            remoteUri = "https://quickitsupport.gdn.accenture.com//solution/ph_solutions/Clear_Group_PolicyCache.exe";
            string myStringWebResource = null;
            // Create a new WebClient instance.
        ...
        private void IPUInstallFixtoolStripMenu_Click(object sender, EventArgs e)
        {
            ...
            remoteUri = "https://quickitsupport.gdn.accenture.com//solution/ph_solutions/IPU_Unable_to_install_Fix.exe";
            string myStringWebResource = null;
            // Create a new WebClient instance.
        ...
        private void NetFrameworkFixtoolStripMenu_Click(object sender, EventArgs e)
        {
            ...
            remoteUri = "https://quickitsupport.gdn.accenture.com//solution/ph_solutions/Net_Framework_Fix.exe";
            string myStringWebResource = null;
            // Create a new WebClient instance.
        ...
        private void toolStripMenuWorkStationIssue_Click(object sender, EventArgs e)
        {
            ...
            remoteUri = "https://quickitsupport.gdn.accenture.com//solution/ph_solutions/Windows_Workstation_Network_Access_Issue.exe";
            string myStringWebResource = null;
            // Create a new WebClient instance.
        ...
        private void btnAzure_Click(object sender, EventArgs e)
        {
            ...
            Process.Start("https://quickitsupport.gdn.accenture.com/ph_doc/Accessing_Azure_or_MS_Portal_Tenant.pdf");
        }
        ...
        private void HomeFormPH_FormClosing(object sender, FormClosingEventArgs e)
        {
            if (executed)
            {
                // subcategory.Add("text");
                FeedbackFormPH feedback = new FeedbackFormPH(subcategory, categoryData);
                feedback.ShowDialog();
        ...
        private void button12_Click(object sender, EventArgs e)
        {
            if (scriptname == "HfB PIN Reset Options")
            {
                ...
                Process.Start("https://quickitsupport.gdn.accenture.com/ph_doc/Using_the_system_setting_if_your_desktop_is_in_unlocked_screen_mode.pdf");
            }
            if (scriptname == "FIDO2 Set-up and Registration")
            {
                ...
                Process.Start("https://quickitsupport.gdn.accenture.com/ph_doc/FIDO2_Token_Setup_and_Registration_for_Windows_(OS).pdf");
            }
            if (scriptname == "Ordering a FIDO2 Token")
            {
                ...
                Process.Start("https://quickitsupport.gdn.accenture.com/ph_doc/Recommended_Tokens.pdf");
            }
        }
        ...
        private void btnHfbT2_Click(object sender, EventArgs e)
        {
            if (scriptname == "HfB PIN Reset Options")
            {
                ...
                subcategory.Add("HfB PIN Reset Options");
                saveExecutionLog("HfB PIN Reset Options");
                Process.Start("https://quickitsupport.gdn.accenture.com/ph_doc/Passwordless_Enabled_Using_the_system_settings_from_the_unlocked_screen.pdf");
            }
            if (scriptname == "FIDO2 Set-up and Registration")
            {
                executed = true;
                subcategory.Add("FIDO2 Set-up and Registration");
                saveExecutionLog("FIDO2 Set-up and Registration");
                Process.Start("https://quickitsupport.gdn.accenture.com/ph_doc/FIDO2_Token_Setup_and_Registration_for_MAC_(OS).pdf");
            }
            if (scriptname == "Ordering a FIDO2 Token")
            {
                executed = true;
                subcategory.Add("Ordering a FIDO2 Token");
                saveExecutionLog("Ordering a FIDO2 Token");
                Process.Start("https://quickitsupport.gdn.accenture.com/ph_doc/Users_unable_to_locate_their_shipping_address_during_profile_setup.pdf");
            }
        }
        ...
        private void btnHfbT3_Click(object sender, EventArgs e)
        {
            if (scriptname == "HfB PIN Reset Options")
            {
                ...
                subcategory.Add("HfB PIN Reset Options");
                saveExecutionLog("HfB PIN Reset Options");
                Process.Start("https://quickitsupport.gdn.accenture.com/ph_doc/Passwordless_Enabled_Pin_Reset_from_the_locked_screen.pdf");
            }
            if (scriptname == "FIDO2 Set-up and Registration")
            {
                executed = true;
                subcategory.Add("FIDO2 Set-up and Registration");
                saveExecutionLog("FIDO2 Set-up and Registration");
                Process.Start("https://quickitsupport.gdn.accenture.com/ph_doc/Registering_a_FIDO2_Token_Key_for_Privileged_Accounts.pdf");
            }
            if (scriptname == "Ordering a FIDO2 Token")
            {
                executed = true;
                subcategory.Add("Ordering a FIDO2 Token");
                saveExecutionLog("Ordering a FIDO2 Token");
                Process.Start("https://quickitsupport.gdn.accenture.com/ph_doc/Search_results_indicate_that_the_Feitian_products_are_not_found.pdf");
            }
        }
        ...
        private void HFBManualEnrollToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            Process.Start("https://quickitsupport.gdn.accenture.com/ph_doc/ACN_Hfb_Manual_Enrollment_utility_Instructions.pdf");
            executed = true;
        }
        ...
        private void toolStripMenuHFBAutoEnroll_Click(object sender, EventArgs e)
        {
            ...
            Process.Start("https://quickitsupport.gdn.accenture.com/ph_doc/ACN_Hfb_Automated_Enrollment_utility_Instructions.pdf");
            executed = true;
        }
        ...
        private void toolStripMenuReachTool_Click(object sender, EventArgs e)
        {
            ...
            remoteUri = "https://quickitsupport.gdn.accenture.com//solution/ph_solutions/REACH.zip";
        ...
        private void btndownloadruntime_Click(object sender, EventArgs e)
        {
            ...
            if (fileName != null)
            {
                ...
                if (ifFileExist)
                {
                    ...
                    remoteUri = "https://quickitsupport.gdn.accenture.com//solution/ph_solutions/REACH_runtime.zip";
        ...
        private void PasswordfaqstoolStrip_Click(object sender, EventArgs e)
        {
            subcategory.Add(sender.ToString());
            saveExecutionLog(sender.ToString());
            Process.Start("https://in.accenture.com/connectivitysecurity/passwordless-faqs/");
        ...
        private void gPHFixToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            remoteUri = "https://quickitsupport.gdn.accenture.com//solution/ph_solutions/GPH_Remediation.exe";
