...
{
    public partial class FeedbackFormPH : Form
    {
        string hostName = "xyz";
        Boolean check = false;
       ...
       public List<string> subCatList = new List<string>();
        ...
        string catstr = "";
        string substr = "";
        public FeedbackFormPH(List<string> lst,DataTable dt)
        {
            dtCategory = dt;
             InitializeComponent();
            subCatList = lst;
        ...
        //    FeedbackFormPH ff = new FeedbackFormPH();
            ...
            try
            {
                ...
                using (var wb = new WebClient())
                {
                    data = Environment.UserName; ;
                     ...
                     response = wb.DownloadString("https://quickitsupport.gdn.accenture.com/starttool_ph/getcat.php");
            ...
            if (!checkData())
            {
                ...
                try
                {
                    using (var wb = new WebClient())
                    {
                        ...
                        var response = wb.UploadValues("https://quickitsupport.gdn.accenture.com/starttool_ph/savefeedback.php", "POST", senddata);
        ...
        private void linkLabelloginc_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            ...
            try
            {
                ...
                using (var wb = new WebClient())
                {
                    ...
                    var sendData = new NameValueCollection();
                    sendData.Add("d1", encrypted);
                    var response = wb.UploadValues("https://quickitsupport.gdn.accenture.com/starttool_ph/incident.php", "POST", sendData);
        ...
        private void FeedbackFormPH_FormClosing(object sender, FormClosingEventArgs e)
        {
